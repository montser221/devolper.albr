  ...
  @enderror
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel"  data-interval="false">
      ...
      {{-- @if ($project->projectStatus==1) --}}
       ...
       <img style="margin-bottom: 170px !important;max-height:500px;" src="{{ url("uploads/".$project->projectImage)}}" class="d-block w-100" alt="...">
       ...
       <div class="container">
         ...
         <div class="panel _panel col-sm-hidden">
           ...
           <div class="row" style="max-height:160px">
             ...
             <div class="col-md-4" style="display: flex;">
              <a href="{{route('projectDetail',$project->projectId)}}">
               ...
               <div class="project-name">
                 ...
                 {{  substr($project->projectDesc,0,60) }}
             ...
             <div class="col-md-4">
               <?php
                $getAllDenoate = $project->denoate_sum_money_value;
               ?>
               <div class="denoate">
                 ...
                 style="@if($getAllDenoate > 0)  background-color:#8eb527 !important; @else  background-color:#e9ecef;width:15% !important;  @endif @if($getAllDenoate >= $project->projectCost ) width:100%;  @else  width: {{  round($getAllDenoate / $project->projectCost * 100)  }}%; @endif" aria-valuenow="25"
    ...
    <div class="row">
      ...
      <div class="col-sm-12  col-md-6 col-lg-5 word-text" style="color:#777"> --}}
         <div class="text-center lead mt-2">
                ( مدة دورة المجلس الرابعة والمدة المتاحة من   1441/12/29  هــ الى       1445/12/29هــ)
            </div>
      ...
      <br>
        ...
        <div id="carouselImage" class="carousel slide" data-ride="carousel" data-interval="false"> <!-- Start Carousel -->
          ...
          <ol class="carousel-indicators">
            ...
            data-slide-to="{{$x}}" 
            class="<?php echo $x==0?'active':'' ?>" 
            style="background-image:url(<?php echo  url("storage/".$img->imageFile); ?>);
            ...
            <div class="carousel-inner">
              ...
              @foreach ($images as $img)
                ...
                <div class="carousel-item <?php echo $z==1 ? "active" :''  ?>" id="first-slide">
                  ...
                  <img style="max-width: 250px;"  src="<?php echo  url("storage/".$img->imageFile) ?>" class="d-block image"  alt="{{ $img->imageTitle }}">
      ...
      <div class="col-sm-12 col-md-3 versions 4 mt-5 center-phone">
        ...
        <?php $file_count++;?>
         ...
         @else
          ...
          <span class="img-title" style="color:#0882b2"> {{ $file->fileTitle }}</span>
          </a>
