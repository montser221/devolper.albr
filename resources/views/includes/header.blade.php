             ...
             <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                   ...
                   @isset($otherFiles)
                    @foreach ($otherFiles as $file)
                      <a class="dropdown-item"href="{{ url("uploads/otherfile/". $file->memFile) }}"  target="_blank"> {{ $file->memName }} </a>
                    @endforeach
                   @endisset
             </div>
           </li>
            ...
            <li class="nav-item dropdown">
               ...
               الخدمات الالكترونية
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLinkSer">
                  ...
                  <a class="dropdown-item" href="https://www.bir-almoaih.org/profile-request"> تسجيل مستفيد</a>
