  ...
  <div class="container">
    <div class="h2 text-center main-color">
       ...
       <div class="col-sm-4 text-center "  style="margin:0 auto">
        <img class="img-fix mt-5" src="{{url("uploads/members/1614096279281208307061.png")}}" alt="">
        
            <a class="ml-3" target="_blank" href="https://wa.me/9660555570381">
           <img style="width: 50px;" src="{{url('design/icons/whatsapp.png')}}" />
          </a>
    
           <a href="mailto:biralmuwayh@hotmail.com" 
              style="background-color: #2fa89c;color: #fff;width: 66px;height: 52px;border-radius: 16px;">
            <i class="fa fa-envelope fa-3x" aria-hidden="true"></i>
            </a>
              
      
            <div class="h4 mr-5  mt-4 mb-4">
                بندر محارب العتيبي
            </div>
            <div class="h5 text-center mr-5 mb-5 main-color"> 
                   المدير التنفيذي  
            </div>
        </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6   ">
          ...
          <div class="item-2">
            ...
            <i class="fa fa-calendar fa-lg ml-3 main-color"></i> <span> {{\Carbon\Carbon::createFromFormat('H:i:s',$attend->startAt)->format('h:i')}}
 </span> - <span> {{\Carbon\Carbon::createFromFormat('H:i:s',$attend->endAt)->format('h:i')}} </span>
