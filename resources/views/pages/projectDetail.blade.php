...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/ar_AR/sdk.js#xfbml=1&version=v9.0" nonce="rcB6zvfw"></script>
                 ...
                 style="@if($getAllDenoate > 0)  background-color:#8eb527 !important; @else  background-color:#e9ecef;width:15% !important;  @endif @if($getAllDenoate >= $projectData->projectCost ) width:100%;  @else  width: {{  round($getAllDenoate / $projectData->projectCost * 100)  }}%; @endif" aria-valuenow="25"
