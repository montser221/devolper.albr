              ...
              <form  id="user-create-form" enctype="multipart/form-data" method="post" action="{{route('users.store')}}">
                ...
                <div class="form-row">
                  ...
                  <div class="col">
                    ...
                    <select class="form-control" name="userCategoryIdTable"  required>

                        <option disabled  >أختر المجموعة</option>
                ...
                <div class="form-row">
                  ...
                  <div class="col">
                    ...
                    <label class="label-control" for="password_confirmation ">أعادة كلمة المرور</label>

                    <input id="confirmPassword" type="password" name="password_confirmation " class="form-control" placeholder="أعادة كلمة المرور">
