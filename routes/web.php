...
//export conatctus
Route::get('exportcontact', [App\Http\Controllers\ContactController::class,'exportcontact'])->name('exportcontact')->middleware('auth');
...
// thanks area 
Route::get('thanks',[App\Http\Controllers\DoneController::class,'thanks'])->name('thanks');
//Route::resource('thanks',App\Http\Controllers\DoneController::class);
